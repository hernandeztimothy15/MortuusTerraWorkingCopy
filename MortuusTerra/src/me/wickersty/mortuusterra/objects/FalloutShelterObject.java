...
public class FalloutShelterObject {
	...
	private void generateFalloutShelter() {
		...
		chestInventory.addItem(new ItemStack(Material.TNT, 4));
		chestInventory.addItem(new ItemStack(Material.IRON_BLOCK, 2));
		chestInventory.addItem(new ItemStack(Material.TORCH, 64));
		chestInventory.addItem(new ItemStack(Material.BEDROCK, 8));
		chestInventory.addItem(new ItemStack(Material.WHEAT, 32));
		chestInventory.addItem(new ItemStack(Material.CAKE, 2));
		chestInventory.addItem(new ItemStack(Material.SUGAR_CANE, 16));
		chestInventory.addItem(new ItemStack(Material.STONE, 64));
		chestInventory.addItem(new ItemStack(Material.PUMPKIN_STEM, 8));
		chestInventory.addItem(new ItemStack(Material.MELON_STEM, 8));
		chestInventory.addItem(new ItemStack(Material.IRON_SHOVEL, 4));
		chestInventory.addItem(new ItemStack(Material.IRON_PICKAXE, 4));
		chestInventory.addItem(new ItemStack(Material.IRON_AXE, 4));
		chestInventory.addItem(new ItemStack(Material.STONE_SWORD, 4));
		chestInventory.addItem(new ItemStack(Material.COAL, 32));
		chestInventory.addItem(new ItemStack(Material.FLINT_AND_STEEL, 1));
		chestInventory.addItem(new ItemStack(Material.DIAMOND, 8));
		chestInventory.addItem(new ItemStack(Material.GOLD_INGOT, 16));
