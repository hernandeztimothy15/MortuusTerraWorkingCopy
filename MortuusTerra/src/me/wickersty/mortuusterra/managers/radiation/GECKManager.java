...
public class GECKManager {
	...
	public boolean isValidGECK(Location location) {
		...
		if (piston1.getType().equals(Material.PISTON) && piston2.getType().equals(Material.PISTON) && piston3.getType().equals(Material.PISTON) && piston4.getType().equals(Material.PISTON)) { } else {
